# Arduino Joystick Library 2

#### Version 0.1
#### Core Version 2.0.7 by Matthew Heironimus
...
- `FullRangeTest` - Simple test demonstrating the full range modification allowing for 0 - 65535 range.
